...
open class TagView: UIButton {
    ...
    open var textAttributes: [NSAttributedString.Key: Any] = [:] {
        didSet {
            ...
            attributedString.addAttributes(textAttributes, range: NSRange(0..<attributedString.length))
    ...
    override open var intrinsicContentSize: CGSize {
        ...
        let lineHeight = (textAttributes[.paragraphStyle] as? NSParagraphStyle)?.minimumLineHeight ?? textFont.pointSize
        size.height = lineHeight + paddingY * 2
